...
<script>
	...
	// drop zone 을 클릭했을때 input type="file"을 강제 클릭해서 파일 선택장이 열리도록 한다
	...
	// drag drop 이 아니고 파일을 직접 선택했을때 input type="file" 에 change 이벤드가 발생한다.
    ...
    async function updatePreview() {
		...
		//선택한 파일객체가 들어있는 배열을 input type="file" 의 value로 넣어준다.
    ...
    // 폼에 "submit" 이밴트가 일어 났을때 실행할 함수 등록
